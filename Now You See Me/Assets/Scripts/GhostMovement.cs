...
public class GhostController : MonoBehaviour, IGhostController
{
    ...
    //�µ�shake
    private Vector3 originalChildPosition; // ��¼�Ӷ���ĳ�ʼλ��
    private Transform childToShake; // ���õ�һ���Ӷ���
    ...
    void Start()
    {
        ...
        {
            childToShake = transform.GetChild(0); // ��ȡ��һ���Ӷ���
            originalChildPosition = childToShake.localPosition; // ��¼�Ӷ���ĳ�ʼλ��
        }
        else
        {
    ...
    public void Stun(float duration)
    {
        ...
        if (dropManager != null)
    {
        dropManager.DropItem(transform.position); // 在鬼魂当前位置掉落物品
    }
    else
    {
